...
- **聰明提款機 (Smart Withdrawal)** — 當需要用錢時，依 Liquidity Waterfall 三層優先演算法產生賣出建議：(1) 再平衡超配資產 (2) Tax-Loss Harvesting 節稅 (3) 按流動性順序賣出（Cash→Bond→Growth→Moat→Trend Setter），避免隨便賣掉表現最好的股票或錯失反彈機會。支援 Telegram 通知與 Webhook
